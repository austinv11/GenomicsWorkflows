...
apptainer build "$(pwd)/10xrangers/10x_ranger_image.sif" "$(pwd)/10xrangers/Dockerfile"
...
apptainer build "$(pwd)/multiqc/multiqc_image.sif" "$(pwd)/multiqc/Dockerfile"
...
apptainer build "$(pwd)/samtools/samtools_image.sif" "$(pwd)/samtools/Dockerfile"
